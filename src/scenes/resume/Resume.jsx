          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              ...
              <ResumeItem title="Web Developer">
                ...
                <p>
                  Design and production 8 projects of organizational processes
                  on the web based on SAP with bpmn process maker tool
                </p>
                <p>
                  <ul>
                    <li>
                    ...
                    <li>
                      The system of defining the identity, occupational and
                      legal information of the new employee
                    </li>
              ...
              <ResumeItem title="Human Resources Expert">
                ...
                <p>
                  <em>
                    Negin Salamat Institute, Contractor of Health Center No. 1
                    in Mashhad - Mashhad,Iran
                  </em>
                </p>
                <p>
                  <ul>
