        ...
        <div className="row">
          ...
          <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <p>
              ...
              processes with the processmaker tool based on SAP best practice.In
              the work environment, I attach great importance to responsibility,
              honesty and discipline, and I interact well with people
            </p>
          </div>
        </div>
      </div>
